    ...
    <MusicLayout>
        ...
        <template #content>
            <form @submit.prevent="submit">
                <div class="mb-3">
                    <label for="title" class="block text-gray-700 text-sm font-bold mb-3">Titre</label>
                ...
                <div class="mb-3">
                    ...
                    <input v-model="form.artist" type="text" name="title" id="title" placeholder="Title" class="shadow border rounded py-2 px-3 text-gray-700 appearance-none leading-tight focus:outline-none focus:shadow-outline mb-5">
                ...
                <input type="submit" value="Create la music" class="bg-blue-700 hover:bg-blue-300 text-white rounded py-2 px-4" :disabled="form.processing">
